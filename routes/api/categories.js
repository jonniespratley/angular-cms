 ...
 * @created 10/23/12
 * 
 * Resource - This is the resource object that contains all of the REST api methods for a full CRUD on a mongo category document.
 * 
 * REST METHODS:
 * 
 * HTTP     METHOD          URL    
 * ======|==============|==============================================                         
 * GET      findAll         http://localhost:3000/categories 
 * GET      findById        http://localhost:3000/categories/:id 
 * POST     add             http://localhost:3000/categories 
 * PUT      update          http://localhost:3000/categories/:id 
 * DELETE   destroy         http://localhost:3000/categories/:id 
 * 
 * //Resource usage
 * var categories = require('./routes/categories');
 * app.get('/categories', categories.Resource.findAll);
 * app.post('/categories', categories.Resource.add);
 * app.put('/categories/:id', categories.Resource.update);
 * app.get('/categories/:id', categories.Resource.findById);
 * app.post('/categories/:id', categories.Resource.destroy);
 */
var Resource = {
host: 'localhost',
port: 27017,
