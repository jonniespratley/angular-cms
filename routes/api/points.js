 ...
 * @created 10/23/12
 * 
 * Resource - This is the resource object that contains all of the REST api methods for a full CRUD on a mongo point document.
 * 
 * REST METHODS:
 * 
 * HTTP     METHOD          URL    
 * ======|==============|==============================================                         
 * GET      findAll         http://localhost:3000/points 
 * GET      findById        http://localhost:3000/points/:id 
 * POST     add             http://localhost:3000/points 
 * PUT      update          http://localhost:3000/points/:id 
 * DELETE   destroy         http://localhost:3000/points/:id 
 * 
 * //Resource usage
 * var points = require('./routes/points');
 * app.get('/points', points.Resource.findAll);
 * app.post('/points', points.Resource.add);
 * app.put('/points/:id', points.Resource.update);
 * app.get('/points/:id', points.Resource.findById);
 * app.post('/points/:id', points.Resource.destroy);
 */
var Resource = {
host: 'localhost',
port: 27017,
